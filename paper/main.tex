...
\section{The algorithm}
	...
	\pyfile{branch_decomposition.py}{19}{27}
	...
	\subsection{Minimum Branch Decomposition from Minimum Carving Decomposition}
		...
		\pyfile{branch_decomposition.py}{6}{17}

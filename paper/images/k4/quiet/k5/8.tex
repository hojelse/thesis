\begin{tikzpicture}
	...
	\begin{scope}[xshift=0cm, yshift=0cm, scale=0.4]
		...
		\draw[draw, line width=1] (5) -- node[below left] {1} (6);
		\draw[draw, line width=1] (5) -- node[above right] {2} (4);
		\draw[draw, line width=1] (4) -- node[above left] {3} (6);
		\draw[draw, line width=1] (3) -- node[below] {4} (6);
		\draw[dashed] (3) -- node[right] {5} (2);
		\draw[dashed] (6) -- node[left] {6} (2);
		\draw[dashed] (2) -- node[below left] {7} (5);
		\draw[dashed, line width=3] (1) -- node[below right] {8} (2);
